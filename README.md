# 집콕맵 - 서울 아파트 실거래가·학군·학원비·출퇴근 시간 지도

### 👉 **https://jipkokmap.kr** (서울 6,809개 단지)

본인 예산에 맞는 학군지 아파트를 찾도록 돕는 모바일 우선 웹앱. 설치·로그인 없이 바로 씁니다.

| 기능 | 설명 |
|---|---|
| [동네 학원비](https://jipkokmap.kr/rank/academy-fee.html) | 교육청 공시 교습비로 계산한 단지 반경 1km 월 학원비 중앙값 (강남 36만 vs 강북 19.8만) |
| [예산별 학군지](https://jipkokmap.kr/rank/budget-school.html) | 같은 가격대 안에서의 학군 순위 — "내 6억으로 갈 수 있는 최고 학군" |
| 출퇴근 시간 | 회사 역을 넣으면 지하철 소요 시간 계산, 맞벌이 두 곳 동시 조건 |
| [공사 중 예정역](https://jipkokmap.kr/rank/future-rail.html) | 동북선 등 공사 중 노선 예정역 도보권 단지 |
| 배정 초등학교 | 공식 학구도 기준 배정 학교, 통학 거리, 학급당 인원 |
| 실거래·전세가율 | 국토교통부 실거래가, 갭, 상승·위험 신호 |

데이터 출처와 계산 방식은 [지표 설명](https://jipkokmap.kr/guide.html)에 전부 공개돼 있습니다.

정적 파일(HTML/JS) + Python 파이프라인으로 만듭니다.
